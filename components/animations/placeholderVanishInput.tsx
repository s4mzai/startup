    ...
    >
      ...
      {value && (
        <button
          ...
          className="absolute right-12 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full bg-gray-200 hover:bg-gray-300 transition duration-200 flex items-center justify-center"
        >
          <svg
